...
function boldPara(text) {
    return new Paragraph({
        children: [new TextRun({ text: text, font: FONT_KAITI, size: FONT_SIZE_BODY, bold: true })],
...
const doc = new Document({
    sections: [{
        ...
        children: [
            ...
            bodyPara("登录系统后，默认进入全景大屏页面。该页面展示校园网整体态势概览："),
            createTable(
                ["区域", "说明"],
                [
            ...
            heading3("5.3.2  安全态势"),
            bodyPara("进入安全态势页面，查看全网安全状况和攻击分布："),
            createTable(
                ["区域", "说明"],
                [
                    ["3D地球", "展示全球攻击源分布和攻击弧线"],
            ...
            boldPara("操作提示："),
            bulletPara('点击3D地球上的攻击弧线，可查看该攻击的详细信息'),
            bulletPara("点击告警列表中的告警项，可展开查看详情"),
            ...
            bulletPara("在任意页面点击IP地址（如流检索结果中的源IP）"),
...
Packer.toBuffer(doc).then(buffer => {
    fs.writeFileSync("D:/ASUS/Documents/jiedan/waibao/waibu/第五章_安装及使用_v2.docx", buffer);
    console.log("文档已生成：第五章_安装及使用_v2.docx");
});
